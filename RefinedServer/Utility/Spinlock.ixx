...
export namespace util
{
	...
	private:
		util::atomic_flag mySwitch;
	};
}

export using util::memory_order;
export using util::memory_order_relaxed;
export using util::memory_order_consume;
export using util::memory_order_acquire;
export using util::memory_order_release;
export using util::memory_order_acq_rel;
export using util::memory_order_seq_cst;
